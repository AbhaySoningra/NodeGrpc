...
var routeguide = grpc.loadPackageDefinition(packageDefinition).com.em.ins;
var client = new routeguide.InstallerService('192.168.0.113:42148',
...
function runGetFeature(callback) {
  ...
  console.log('Found no feature at 1')
  client.getFeature(point2, featureCallback);
  console.log('Found no feature at 2')
  client.getFeature(point3, featureCallback);
  console.log('Found no feature at 3')
}
...
function runGetFeatureByName(callback) {
  console.log('Here');
  function featureCallback(error, feature) {
    if (error) {
      callback(error);
  ...
  client.getFeatureByName(feature, featureCallback);
}
...
/*
* Installer service calling method
*/
...
function testCall(){
  function featureCallback(error, feature) {
    ...
    console.log('Response found', feature);
  }
  var inRequest = {
    transId : 1001,
    type : 0,
  ...
  client.checkAndAdd(inRequest, featureCallback);
}
/**
...
exports.runGetFeatureByName = runGetFeatureByName;
